      ...
      <div className="max-w-4xl mx-auto">
        ...
        {currentSection === 'start' && (
          <div className="bg-white p-8 rounded-lg shadow">
            ...
            <Button onClick={() => setCurrentSection('a')}>
              Start
            </Button>
          </div>
        )}
        ...
        {currentSection === 'c' && (
          <>
            ...
            <Button onClick={() => setCurrentSection('symptoms')}>
              Next
            </Button>
          </>
        )}
        ...
        {currentSection === 'd' && (
          <>
            ...
            <Button onClick={() => setCurrentSection('e')}>
              Next
            </Button>
          </>
        )}
        ...
        {currentSection === 'symptoms' && (
          <>
            <CVSSymptomsSection
              ...
              onSymptomChange={(v) =>
                handleFieldChange('visual_symptoms', v)
              }
              onScoreChange={(v) =>
            ...
            <Button onClick={() => setCurrentSection('d')}>
              Next
            </Button>
          </>
        )}
