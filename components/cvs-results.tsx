      ...
      <div className="p-8 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 text-center">
              ...
              <p className="text-3xl font-bold text-orange-600">{extraOcularScore}</p>
            </div>
          </div>
        </div>
        ...
        <div className={`${colorClasses} border rounded-lg p-6`}>
          <div className="flex justify-between items-center">
            <div>
              <p className="text-sm font-medium text-gray-600 mb-2">Total CVS Score</p>
              <p className={`text-4xl font-bold ${textColorClass}`}>{totalScore}</p>
            </div>
            <div className="text-right">
              <p className="text-sm font-medium text-gray-600 mb-2">Risk Level</p>
              <p className={`text-2xl font-bold ${textColorClass}`}>{riskLevel}</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3 text-gray-700">
            {totalScore <= 2 && (
              <>
                ...
                <p>✓ Continue maintaining good screen habits and eye care practices</p>
            ...
            {totalScore > 6 && (
              <>
                ...
                <p>• It is strongly recommended to consult an eye care professional</p>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-sm text-yellow-900">
            <strong>Disclaimer:</strong> This assessment is for informational purposes only and should
            not replace professional medical advice. Please consult an eye care professional for proper
